...
\lst"-advi", \lst"-xdvi", \lst"-ps",  \lst"-kpdf", \lst"-gpdf", \lst"-skim", \lst"-mupdf", or \lst"-pdf" (see section~\ref{types})
...
{\tt -advi}, {\tt -dvi}, {\tt -ps}, {\tt -kpdf},  {\tt -gpdf},  {\tt -nopdf}, {\tt -mupdf}, {\tt -skim}, or {\tt -pdf}. 
